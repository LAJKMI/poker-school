...
export default function HandRankings() {
    return (
        <section id="handRankings">
            ...
            <SectionHeading
                heading="Understanding Poker Hand Rankings"
                info="All poker games are won by making the best five-card hand (except in special cases like Lowball). Below is the standard hand ranking, from strongest to weakest:"
            />
            <div className="hands">
                <Hand
